...
public class ZkClientUtil {
     static final int BASE_SLEEP_TIME_MS = 5000; //定义失败重试间隔时间 单位:毫秒
     static final int MAX_RETRIES = 3; //定义失败重试次数
     static final int SESSION_TIME_OUT = 1000000; //定义会话存活时间,根据业务灵活指定 单位:毫秒
     static final String ZK_URI = "127.0.0.1:2181";//你自己的zkurl和端口号
     static final String NAMESPACE = "laohan_jianshen";
